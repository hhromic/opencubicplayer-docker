...
ADD https://github.com/mywave82/opencubicplayer.git?tag=v3.4.1 ocp/
RUN cd ocp \
...
ADD --chmod=644 \
    https://github.com/mrbumpy409/GeneralUser-GS/raw/97049183643d5fc5a9322a69c5b09efb667c6c3a/GeneralUser-GS.sf2 \
